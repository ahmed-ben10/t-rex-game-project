class Player{
    ...
    constructor(x, y,vy, w, h,hs, canvas, c){
        this.x = x;
        this.y = y;
        this.w = w;
        this.h = h;
    ...
    drawImage(){
        ...
        if(this.GameOver) this.image.src ="./assets/dino/dino.png";
    ...
    drawScore(){
        ...
        this.c.fillText(scoreDisplay , this.canvas.width-120, 30);
        this.c.fill();
    }
